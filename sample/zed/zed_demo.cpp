...
int main(int argc, char* argv[]) {	
	...
	sl::Mat d_zed_image_l(zed.getCameraInformation().camera_resolution, sl::MAT_TYPE::U8_C1, sl::MEM::GPU);
	sl::Mat d_zed_image_r(zed.getCameraInformation().camera_resolution, sl::MAT_TYPE::U8_C1, sl::MEM::GPU);
