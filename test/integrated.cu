...
class LibSGM : public testing::TestWithParam<std::tuple<int, int, int, sgm::PathType, sgm::EXECUTE_INOUT>> {
public:
	...
	virtual void SetUp(){
		std::tie(input_depth_bits_, output_depth_bits_, disparity_size_, path_type_, inout_type_) = GetParam();
...
TEST_P(LibSGM, Integrated){
	...
	sgm::StereoSGM sgm(WIDTH, HEIGHT, disparity_size_, input_depth_bits_, output_depth_bits_, inout_type_, {10, 120, 0.95f, false, path_type_});
